...
$('body').on('click','.slide-out-widget-area-toggle a.closed:not(.animating)',function(){
	...
	if($('#boxed').length == 0) {
		$('.container-wrap, .home-wrap, #header-secondary-outer, #footer-outer, #page-header-bg, .page-header-no-bg').stop(true).transition({ x: '-300px' },750,'easeInOutCubic');
...
$('body').on('click','.slide-out-widget-area-toggle a.open:not(.animating), #slide-out-widget-area .slide_out_area_close',function(){
	...
	$('.container-wrap, .home-wrap, #header-secondary-outer, #footer-outer, #page-header-bg, .page-header-no-bg').stop(true).transition({ x: '0px' },750,'easeInOutCubic');
	...
	//if($('#header-outer[data-transparency-option="1"]').length > 0  && $('#boxed').length == 0 && $('#header-outer[data-full-width="true"]').length > 0) {
		if($('#header-outer.small-nav').length > 0) $('#header-outer').removeClass('transparent');
	//} 
		...
		if($offset > 0 && $windowWidth > 1000) {
			...
			if($('body.ascend ').length > 0 && $('#header-outer[data-full-width="true"]').length > 0) {
				$('header#top nav > ul.buttons').stop(true,true).animate({
					...
					'height' : Math.ceil((headerPadding*2)/ 1.8 + logoHeight-shrinkNum)
				},{queue:false, duration:250, easing: 'easeOutCubic'});	
		...
		if($offset == 0 && $windowWidth > 1000) {
			...
			if($('body.ascend ').length > 0 && $('#header-outer[data-full-width="true"]').length > 0) {
				$('header#top nav > ul.buttons').stop(true,true).animate({
					...
					'height' : headerPadding*2 + logoHeight
				},{queue:false, duration:250, easing: 'easeOutCubic'});	
...
$('body').on('click','#header-outer nav .sf-menu a, .container-wrap a:not(.wpb_tabs_nav a), #slide-out-widget-area a, #mobile-menu .container ul li a',function(e){
